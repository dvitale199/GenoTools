...
def get_raw_files(geno_path, ref_path, labels_path, out_path):
    ...
    ext_snps_cmd = f'/data/vitaled2/GenoTools_dev/GenoTools/exec/plink2 --bfile {geno_prune_path} --extract {common_snps} --alt1-allele {ref_common_snps_ref_alleles} --make-bed --out {geno_common_snps}'
